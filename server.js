...
app.post('/iclock/cdata', (req, res) => {
  ...
  for (const line of lines) {
    ...
    // Skip logs that are not in expected format
    if (parts.length < 3) {
      console.warn('❌ Ignored - Invalid or failed scan:', line);
      continue;
    }
    ...
    if (statusCode !== '0' && statusCode !== '1') {
      console.warn('❌ Ignored - Invalid status code:', statusCode);
      continue;
    }
    ...
    console.log('✅ Logged:', { userId, status });
  }
